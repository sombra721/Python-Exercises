"""
Created on Thu Mar 13 20:28:13 2014
...
balanced_tree2 = BinaryTree(1)
balanced_tree2.left = BinaryTree(2)
balanced_tree2.left.right = BinaryTree(4)
balanced_tree2.right = BinaryTree(3)
balanced_tree2.right.left = BinaryTree(6)
balanced_tree2.right.right = BinaryTree(7)
balanced_tree2.right.right.right = BinaryTree(8)
balanced_tree2.right.right.right.right = BinaryTree(9)
#building testcase 4
...
test_func = [is_balanced_binary_tree]
print balanced_tree2
print depth(balanced_tree2)
